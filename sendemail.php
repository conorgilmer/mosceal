...
if(isset($_POST['email'])) {
    $email_to = "conor.gilmer@gmail.com"; // who the form sends the email to
    $email_subject = "Mo Sceal Form"; //subject of that msg
	...
	echo "</div> <hr> <div class=\"footer\"> 
        <p> Mo sceal/SocialMediaAPI<sup>TM</sup> Copyright &copy; (<a href=\"mailto:conor.gilmer@gmail.com\">Conor Gilmer</a>) 2013</p> </div>  </div> 
...
$email_mosceal = "conor.gilmer@gmail.com";
$email_thanks= "Thank You ". $first_name . " for your message.\r\n We shall be in touch with you as soon as possible";
// create email headers
$headersrec = 'From: '.$email_mosceal."\r\n".
'Reply-To: '.$email_mosceal."\r\n" .
'X-Mailer: PHP/' . phpversion();
$thankssub = "Mo Sceal Contact Form Thank You!";
...
-->
        ...
        <h1 class="joyce">Contact Form Sent!</h1><p><br></p>
 <a class="btn btn-primary btn-large" href="http://www.conorgilmer.eu">Home Page</a>

      </div>
<div class="span12">
 

Thank you for contacting us. I shall be in touch with you very soon.<br>
 </div>
<?php
}
?>
